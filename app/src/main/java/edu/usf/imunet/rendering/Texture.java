...
public class Texture implements Closeable {
     ...
     */
    public Texture(MotionRajawaliRenderer render, Target target, WrapMode wrapMode) {
        this(render, target, wrapMode, /*useMipmaps=*/ true);
    }

    public Texture(MotionRajawaliRenderer render, Target target, WrapMode wrapMode, boolean useMipmaps) {
        this.target = target;
    ...
    public static Texture createFromAsset(
            MotionRajawaliRenderer render, String assetFileName, WrapMode wrapMode, ColorFormat colorFormat)
            throws IOException {
